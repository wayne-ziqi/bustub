...
INDEXITERATOR_TYPE::IndexIterator(BufferPoolManager *bpm, ReadPageGuard guard, int key_index) {
  ...
  leaf_page_ = guard_.template As<B_PLUS_TREE_LEAF_PAGE_TYPE>();
...
INDEX_TEMPLATE_ARGUMENTS
auto INDEXITERATOR_TYPE::IsEnd() -> bool { return static_cast<bool>(key_index_ == leaf_page_->GetSize()); }

INDEX_TEMPLATE_ARGUMENTS
auto INDEXITERATOR_TYPE::operator*() -> const MappingType & {
  assert(key_index_ < leaf_page_->GetSize());
